...
import { CandidateComparisonMatrix } from '@/presentation/components/hr/CandidateComparisonMatrix';
import { HrFunnelChart } from '@/presentation/components/hr/HrFunnelChart';
import { HrScoreHistogram } from '@/presentation/components/hr/HrScoreHistogram';
import {
  AiConfig,
  HrCvInput,
  HrRankingResult,
