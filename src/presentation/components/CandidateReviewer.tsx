...
import { CandidateScorecard } from '@/presentation/components/candidate/CandidateScorecard';
import { InterviewSimulator } from '@/presentation/components/candidate/InterviewSimulator';
import { ResumeBulletPlayground } from '@/presentation/components/candidate/ResumeBulletPlayground';
import { SkillGapPanel } from '@/presentation/components/candidate/SkillGapPanel';
import { List } from '@/presentation/components/common/List';
import { LongTextBlock } from '@/presentation/components/common/LongTextBlock';
import { MetricBar } from '@/presentation/components/common/MetricBar';
import { ResultPanel } from '@/presentation/components/common/ResultPanel';
import { Score } from '@/presentation/components/common/Score';
import { TextArea } from '@/presentation/components/common/TextArea';
import { TextField } from '@/presentation/components/common/TextField';
...
import {
  ...
  downloadJsonFile,
} from '@/infrastructure/files/exportResults';
import { SUPPORTED_FILE_TYPES, extractTextFromFile } from '@/infrastructure/files/extractText';
