...
const dictionaries: Record<Locale, Dictionary> = {
  'en-US': {
    ...
    'hr.dashboard.comparisonHint':
      'The top candidate sets the benchmark (10.0) while the average reflects general pool quality.',
  ...
  'pt-BR': {
    ...
    'hr.dashboard.comparisonHint':
      'O melhor candidato define a referencia (10.0), enquanto a media reflete a qualidade geral do grupo.',
  ...
  'es-ES': {
    ...
    'hr.dashboard.comparisonHint':
      'El mejor candidato establece la referencia (10.0) mientras que el promedio refleja la calidad general del grupo.',
