...
import { CandidateScorecard } from '@/candidate/CandidateScorecard';
import { InterviewSimulator } from '@/candidate/InterviewSimulator';
import { ResumeBulletPlayground } from '@/candidate/ResumeBulletPlayground';
import { SkillGapPanel } from '@/candidate/SkillGapPanel';
import {
  loadCandidateCvDraft,
  persistCandidateCvDraft,
} from '@/candidate/candidateDraftGateway';
...
import { AiConfig, CandidateReview } from '@/common/core/aiTypes';
import {
  CandidateQualitySummary,
  buildCandidateQualitySummary,
} from '@/common/core/reviewQuality';
import { analyzeSkillGap } from '@/common/core/skillGapAnalysis';
import {
